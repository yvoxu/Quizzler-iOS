...
public class ProgressHUD: UIView {
    ...
    private let keyboardWillShow	= UIResponder.NSNotification.Name.UIKeyboardWillShow
    private let keyboardWillHide	= UIResponder.NSNotification.Name.UIKeyboardWillHide
    private let keyboardDidShow		= UIResponder.NSNotification.Name.UIKeyboardDidShow
    private let keyboardDidHide		= UIResponder.NSNotification.Name.UIKeyboardDidHide

    private let orientationDidChange = UIDevice.NSNotification.Name.UIDeviceOrientationDidChange
